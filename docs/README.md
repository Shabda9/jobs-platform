...
| File | Description |
|------|-------------|
| [01-build-playbook.md](./01-build-playbook.md) | Master build guide, phases, and Cursor prompts |
| [02-database-design.md](./02-database-design.md) | MVP database entities, statuses, and rules |
